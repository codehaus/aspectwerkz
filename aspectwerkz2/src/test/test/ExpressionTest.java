...
public class ExpressionTest extends TestCase {
    ...
    private ReflectionMetaDataMaker m_metaDataMaker = MetaDataMaker.getReflectionMetaDataMaker(ExpressionTest.class.getClassLoader());
    ...
    public void testMatchSingleAnonymousExpression() {
        try {
            ...
            ClassMetaData classMetaDataTrue = m_metaDataMaker.createClassMetaData(ExpressionTest.class);
            ClassMetaData classMetaDataFalse = m_metaDataMaker.createClassMetaData(ExpressionException.class);
            MethodMetaData methodMetaDataTrue = m_metaDataMaker.createMethodMetaData(
                    ExpressionTest.class.getDeclaredMethod("set", new Class[]{})
            );
            MethodMetaData methodMetaDataFalse = m_metaDataMaker.createMethodMetaData(
...
//    }
    ...
    public void testOneLevel_CALL_AND() {
        try {
            ...
            ClassMetaData classMetaData1 = m_metaDataMaker.createClassMetaData(ExpressionTest.class);
            MethodMetaData methodMetaData1 = m_metaDataMaker.createMethodMetaData(
                    ExpressionTest.class.getDeclaredMethod("set", new Class[]{})
            );
            MethodMetaData methodMetaData2 = m_metaDataMaker.createMethodMetaData(
                    ExpressionTest.class.getDeclaredMethod("get", new Class[]{})
            );
            MethodMetaData methodMetaData3 = m_metaDataMaker.createMethodMetaData(
                    ExpressionTest.class.getDeclaredMethod("suite", new Class[]{})
            );
    ...
    public void testOneLevel_SET_AND() {
        try {
            ...
            ClassMetaData classMetaData1 = m_metaDataMaker.createClassMetaData(ExpressionTest.class);
            ClassMetaData classMetaData2 = m_metaDataMaker.createClassMetaData(ExpressionException.class);
            FieldMetaData fieldMetaData1 = m_metaDataMaker.createFieldMetaData(
                    ExpressionTest.class.getDeclaredField("m_name")
            );
            FieldMetaData fieldMetaData2 = m_metaDataMaker.createFieldMetaData(
                    ExpressionTest.class.getDeclaredField("m_type")
            );
    ...
    public void testTwoLevels_SET() {
        try {
            ...
            FieldMetaData fieldMetaData3 = m_metaDataMaker.createFieldMetaData(
