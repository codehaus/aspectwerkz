...
{
    private String java = "a field that can make Javassit confused, AW-147 item2, fixed in AW 0.10.RC2";
    ...
    public void testBeforeAroundAroundAfterAdvice()
    {
        ...
        assertEquals("pre before1 before2 invocation after2 after1 post ",
            m_logString);
    }
    ...
    {
        assertEquals("dummy",
            takesArrayAsArgument(new String[] { "dummy", "test" })[0]);
        assertEquals("test",
            takesArrayAsArgument(new String[] { "dummy", "test" })[1]);
    }
    ...
    public int variousParams1(String str, int i, float f, Object o, long l)
        throws RuntimeException
    {
        return str.hashCode() + i + (int) f + o.hashCode() + (int) l;
    }

    private int variousParams2(float f, int i, String str1, Object o, long l,
    ...
    public float variousParams3(String s, long y, String t, String r, String e,
        int w, String q)
    {
        return 2.5F;
    }
    ...
    public long getPrimitiveAndNullFromAdvice()
        throws RuntimeException
    {
        return 123456789L;
    }
