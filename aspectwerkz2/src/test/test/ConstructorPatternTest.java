...
public class ConstructorPatternTest extends TestCase
{
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(String, int)");
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(java.lang.String,..)");
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(java.lang.*)");
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(*,String)");
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(String, List)");
    ...
    {
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(java.*.*[])");
    ...
    public void testMatchParameterType14()
    {
        //AW-91
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(java.lang.Integer*)");
    ...
    public void testMatchParameterType15()
    {
        //AW-91
        ConstructorPattern constructorPattern = Pattern
            .compileConstructorPattern("new(Integer[])");
        ...
        constructorPattern = Pattern.compileConstructorPattern(
                "new(Integer[][])");
        assertTrue(constructorPattern.matchParameterTypes(
                new String[] { "java.lang.Integer[][]" }));
        assertFalse(constructorPattern.matchParameterTypes(
