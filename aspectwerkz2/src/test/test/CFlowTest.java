...
public class CFlowTest extends WeavedTestCase implements Loggable
{
    ...
    public void testCallWithinCFlowAnonymous()
    {
        ...
        assertEquals("step1Anonymous advice-beforeAnonymous step2Anonymous advice-afterAnonymous ",
            m_logString);
    }
    ...
    public void testCallWithinCFlowWithinCflow()
    {
        ...
        assertEquals("step1_A step1_B advice-before2 step2_B advice-after2 ",
            m_logString);
    }
