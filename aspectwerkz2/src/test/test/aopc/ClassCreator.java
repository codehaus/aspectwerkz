...
/**
 * Test helper for AspectContainer, emulates a ClassLoader hierarchy
 * sys/sub/
 * sys/sub/a
 * sys/sub/b
 *
...
public class ClassCreator
{
    ...
    static
    {
        try
        {
            ...
            CLASSLOADER_DEFINECLASS_METHOD = ClassLoader.class
                .getDeclaredMethod("defineClass",
                    new Class[] { String.class, b.getClass(), int.class, int.class });
    ...
    public static Class createClass(String name, ClassLoader loader)
    {
        try
        {
            ...
            CtMethod m = new CtMethod(CtClass.voidType, "methodAround",
                    new CtClass[] {  }, klass);
            ...
            m = new CtMethod(CtClass.voidType, "methodPre", new CtClass[] {  },
                    klass);
            m.setModifiers(m.getModifiers() | Modifier.PUBLIC);
            ...
            m = new CtMethod(CtClass.voidType, "methodPost",
                    new CtClass[] {  }, klass);
            m.setModifiers(m.getModifiers() | Modifier.PUBLIC);
        ...
        throws Throwable
    {
        ...
        Callable ca = (Callable) (createClass("test.aopc.a.Callee", mySubCLA))
            .newInstance();
        ...
        Callable cb = (Callable) (createClass("test.aopc.b.Callee", mySubCLB))
            .newInstance();
     ...
     * @throws Throwable
     */
    public static Class define(byte[] b, String name, ClassLoader loader)
        throws Throwable
    {
