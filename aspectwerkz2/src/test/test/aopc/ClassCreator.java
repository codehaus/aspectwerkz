...
public class ClassCreator {
    ...
    static {
        try {
            ...
            CLASSLOADER_DEFINECLASS_METHOD = ClassLoader.class.getDeclaredMethod("defineClass", new Class[]{String.class, b.getClass(), int.class, int.class});
    ...
    public static Class createClass(String name, ClassLoader loader) {
        try {
            ...
            if (true) return define(prototype.toBytecode(), name, loader);
    ...
    public static Class define(byte[] b, String name, ClassLoader loader) throws Throwable {
        Object k = CLASSLOADER_DEFINECLASS_METHOD.invoke(loader, new Object[]{name, b, new Integer(0), new Integer(b.length)});
        return (Class)k;
    }
