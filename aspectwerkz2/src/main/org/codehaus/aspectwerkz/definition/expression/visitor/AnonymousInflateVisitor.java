...
public class AnonymousInflateVisitor implements ExpressionParserVisitor
{
    ...
    {
        StringBuffer lhs = (StringBuffer) node.jjtGetChild(0).jjtAccept(this,
                data);
        StringBuffer rhs = (StringBuffer) node.jjtGetChild(1).jjtAccept(this,
                data);
        StringBuffer expr = new StringBuffer("(").append(lhs.toString())
                                                 .append(") OR (")
    ...
    public Object visit(NotNode node, Object data)
    {
        StringBuffer lhs = (StringBuffer) node.jjtGetChild(0).jjtAccept(this,
                data);
        StringBuffer expr = new StringBuffer("NOT (").append(lhs.toString())
                                                     .append(")");
    ...
    public Object visit(Anonymous node, Object data)
    {
        ...
        {
            expression = ns.createCflowExpression(expr.substring(6,
                        expr.length() - 1), "", exprAutoName);
        }
