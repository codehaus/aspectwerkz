...
/**
 * Implements the pointcut concept for catch clauses. Is an abstraction of a well defined point of execution in the
 * program.<br/> Could matches one or many points as long as they are well defined.<br/> Stores the advices for the
 * specific pointcut.
 *
 * @author <a href="mailto:jboner@codehaus.org">Jonas Bonér</a>
 */
public class HandlerPointcut extends AbstractPointcut {
    ...
    /**
     * Creates a new handler pointcut.
     *
     * @param uuid       the UUID for the AspectWerkz system
     * @param expression the expression of the pointcut
     */
    public HandlerPointcut(final String uuid, final Expression expression) {
