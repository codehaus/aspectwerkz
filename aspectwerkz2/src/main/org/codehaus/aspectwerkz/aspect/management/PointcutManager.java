...
public class PointcutManager
{
     ...
     */
    public PointcutManager( /*final String uuid, */
        final String name)
    {
        this( /*uuid, */
            name, DeploymentModel.PER_JVM);
    }
    ...
    public final void addIntroduction(final String introduction)
    {
        synchronized (m_introductions)
        {
            ...
            java.lang.System.arraycopy(m_introductions, 0, tmp, 0,
                m_introductions.length);
    ...
    public final void addIntroductions(final String[] introductions)
    {
        synchronized (m_introductions)
        {
            ...
            java.lang.System.arraycopy(introductions, 0, clone, 0,
                introductions.length);

            final String[] tmp = new String[m_introductions.length
                + introductions.length];
            int i;
    ...
    {
        return getPointcuts(classMetaData, memberMetaData,
     ...
     */
    private List getPointcuts(final ClassMetaData classMetaData,
        final MemberMetaData memberMetaData, final PointcutType pointcutType)
    {
        ...
        final ClassMetaData callerClassMetaData, final PointcutType pointcutType)
    {
        ...
        for (Iterator it = pointcutListToLookIn.iterator(); it.hasNext();)
        {
                ...
                && expression.match(classMetaData, memberMetaData, pointcutType))
            {
                ...
                expressions.add(expression.extractCflowExpression(
                        classMetaData, memberMetaData, pointcutType));
            }
        }
    ...
    public String toString()
    {
        ...
        + m_deploymentModel + ',' + m_introductions + ']';
    }
