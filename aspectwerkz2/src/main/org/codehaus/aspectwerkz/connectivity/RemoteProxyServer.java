...
public class RemoteProxyServer implements Runnable
{
    ...
    static
    {
        ...
        {
            System.out.println(
                "no aspectwerkz resource bundle found on classpath, using defaults");
        ...
        property = properties.getProperty(
                "remote.server.listener.threads.backlog");
        ...
        property = properties.getProperty(
                "remote.server.client.threads.timeout");
        ...
        property = properties.getProperty(
                "remote.server.thread.pool.keep.alive.time");
        ...
        property = properties.getProperty(
                "remote.server.listener.threads.run.as.daemon");
        ...
        property = properties.getProperty(
                "remote.server.thread.pool.wait.when.blocked");
    ...
    private void createBoundedThreadPool(final int threadPoolMaxSize,
        ...
        final int keepAliveTime, final boolean waitWhenBlocked)
    {
