...
set ASPECTWERKZ_LIBS=%ASPECTWERKZ_HOME%\lib\asm-1.4.1.jar;%ASPECTWERKZ_HOME%\lib\asm-util-1.4.1.jar;%ASPECTWERKZ_HOME%\lib\asm-attrs-1.4.1.jar;%ASPECTWERKZ_HOME%\lib\bcel.jar;%ASPECTWERKZ_HOME%\lib\dom4j-1.4.jar;%ASPECTWERKZ_HOME%\lib\qdox-1.3.jar;%ASPECTWERKZ_HOME%\lib\concurrent-1.3.1.jar;%ASPECTWERKZ_HOME%\lib\trove-1.0.2.jar;%ASPECTWERKZ_HOME%\lib\piccolo-1.03.jar;%ASPECTWERKZ_HOME%\lib\jrexx-1.1.1.jar
