...
public class IntroductionDeploymentTest extends WeavedTestCase
{
    public void testPerInstanceMixin()
    {
        ...
        assertNotSame(((Marker) a1).getTargetInstance(),
            ((Marker) a2).getTargetInstance());
        assertEquals(((Marker) a1).getTargetClass(),
            ((Marker) a2).getTargetClass());
    ...
    public void testPerClassMixin()
    {
        ...
        assertEquals(((Marker) c1).getTargetClass(),
            ((Marker) c2).getTargetClass());
    }
