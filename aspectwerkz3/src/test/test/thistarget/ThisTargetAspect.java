...
public class ThisTargetAspect {
    ...
    Pointcut cctor_this(TargetTest caller) {return null;}
    ...
    Pointcut call_this(TargetTest caller) {return null;}

    /** @Expression this(caller) && call(* test.thistarget.*.callAbstract()) && withincode(* test.*.*.testMethodCallTargetThis(..)) */
    Pointcut callAbstract_this(TargetTest caller) {return null;}
