 ...
 */
public class IntroductionTestAspectMyImplReplacement implements Serializable,
    Introductions
{
    ...
    public int variousArguments1(String str, int i, float f, Object o, long l)
        throws RuntimeException
    {
        return str.hashCode() + i + (int) f + o.hashCode() + (int) l;
    }

    public int variousArguments2(float f, int i, String str1, Object o, long l,
