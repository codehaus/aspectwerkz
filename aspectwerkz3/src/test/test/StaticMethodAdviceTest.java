...
public class StaticMethodAdviceTest extends TestCase
{
    ...
    private static int variousParams1(String str, int i, float f, Object o,
        long l) throws RuntimeException
    {
        return str.hashCode() + i + (int) f + o.hashCode() + (int) l;
    }

    public static int variousParams2(float f, int i, String str1, Object o,
        long l, String str2) throws RuntimeException
    {
        return (int) f + i + str1.hashCode() + o.hashCode() + (int) l
        + str2.hashCode();
    }

    public static float variousParams3(String s, long y, String t, String r,
        String e, int w, String q)
    {
        return 2.5F;
    }
    ...
    public static long getPrimitiveAndNullFromAdvice()
        throws RuntimeException
    {
        return 123456789L;
    }
