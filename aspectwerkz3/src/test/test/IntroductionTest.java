...
//        assertEquals("test.aspect.IntroductionTestAspect$MyImpl", SystemLoader.getCflowStack(this)
...
//        assertEquals(-1, ((Introductions) m_toBeIntroduced).intArg(1));
//        assertEquals("test.aspect.IntroductionTestAspect$MyOtherImpl", SystemLoader.getCflowStack(this)
//                .getAspectManager("tests").getMixin("test.aspect.IntroductionTestAspect$MyImpl")
//                .getImplementationClassName());
//    }
//
...
//        assertEquals("test.aspect.IntroductionTestAspectMyImplReplacement", SystemLoader.getCflowStack(
