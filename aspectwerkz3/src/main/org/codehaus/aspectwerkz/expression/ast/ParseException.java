...
/**
 * This exception is thrown when escape errors are encountered. You can explicitly create objects of
 * this exception type by calling the method generateParseException in the generated parser. <p/>You
...
public class ParseException extends Exception {
     ...
     * due to a escape error, the token followng this token will (therefore) be the first error
     * token.
     */
     ...
     * sequence of tokens (by their ordinal values) that is expected at this point of the escape.
     */
    public int[][] expectedTokenSequences;

    /**
     * This is a reference to the "tokenImage" array of the generated parser within which the escape
     ...
     * "expectedTokenSequences", and "tokenImage" setClass. The boolean flag "specialConstructor" is
     * also setClass to true to indicate that this constructor was used to create this object. This
     ...
     * escape error message and returns it. If this object has been created due to a escape error,
