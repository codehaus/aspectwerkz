...
public class ExpressionContext
{
        ...
        final ReflectionInfo withinReflectionInfo)
    {
        ...
        if (reflectionInfo == null)
        {
            throw new IllegalArgumentException(
                "reflection info can not be null");
        }
        ...
        {
            throw new RuntimeException("unknown meta data type: "
                + reflectionInfo.toString());
        }
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!m_matchingReflectionInfo.equals(
                expressionContext.m_matchingReflectionInfo))
        {
            return false;
        }
    ...
    public int hashCode()
    {
        ...
        result = (29 * result)
            ...
            ? m_withinReflectionInfo.hashCode() : 0);
