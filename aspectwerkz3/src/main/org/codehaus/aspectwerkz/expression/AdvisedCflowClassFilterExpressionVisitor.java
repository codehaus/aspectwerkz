<<<<<<< AdvisedCflowClassFilterExpressionVisitor.java
/**************************************************************************************
...
public class AdvisedCflowClassFilterExpressionVisitor extends AdvisedClassFilterExpressionVisitor {
    ...
    public boolean match(final ExpressionContext context) {
        Object result = visit(m_root, context);
        boolean match = ((Boolean) result).booleanValue();
...
//        }
    ...
    public Object visit(ASTPointcutReference node, Object data) {
        ...
        boolean b = namespace.getAdvisedCflowClassExpression(node.getName()).match(context);
