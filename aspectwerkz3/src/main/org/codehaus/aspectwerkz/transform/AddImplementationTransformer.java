...
public class AddImplementationTransformer implements Transformer
{
    ...
    private void addMethodIntroductions(final SystemDefinition definition,
        ...
        final CtClass ctClass, final AddImplementationTransformer transformer)
    {
        ...
        for (Iterator it = introductionDefs.iterator(); it.hasNext();)
        {
            ...
            for (Iterator mit = methodsToIntroduce.iterator(); mit.hasNext();
                methodIndex++)
            {
        ...
        final Context context)
    {
        try
        {
            ...
            TransformationUtil.addAspectManagerField(ctClass, definition,
                context);
