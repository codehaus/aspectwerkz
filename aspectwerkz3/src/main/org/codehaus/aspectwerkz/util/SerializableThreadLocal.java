...
/**
 * Extends the <code>java.lang.ThreadLocal</code> to be able to add additional functionality. <p/>This classes enhances
 * the base implementation by: <p/>making it serializable <p/>making it wrap an unwrap the values in a
