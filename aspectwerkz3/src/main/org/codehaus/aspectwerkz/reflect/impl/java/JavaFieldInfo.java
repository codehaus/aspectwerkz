...
public class JavaFieldInfo extends JavaMemberInfo implements FieldInfo
{
     ...
     */
    public static void addFieldInfo(final Field field,
        final JavaFieldInfo fieldInfo)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        if ((m_attributes != null)
            ? (!m_attributes.equals(javaFieldInfo.m_attributes))
        ...
        if ((m_classInfoRepository != null)
            ? (!m_classInfoRepository.equals(
                javaFieldInfo.m_classInfoRepository))
        ...
        if ((m_declaringType != null)
            ? (!m_declaringType.equals(javaFieldInfo.m_declaringType))
            : (javaFieldInfo.m_declaringType != null))
        {
            return false;
        }

        if ((m_member != null) ? (!m_member.equals(javaFieldInfo.m_member))
                               : (javaFieldInfo.m_member != null))
        {
            return false;
        }

        if ((m_type != null) ? (!m_type.equals(javaFieldInfo.m_type))
                             : (javaFieldInfo.m_type != null))
        {
            return false;
        }
