...
public class JavaClassInfo implements ClassInfo
{
    ...
    {
        m_class = klass;
        m_classInfoRepository = ClassInfoRepository.getRepository(klass
                .getClassLoader());
        ...
        else
        {
            ...
            {
                m_constructors[i] = new JavaConstructorInfo(constructors[i],
                        this);
            }
    ...
    public ClassInfo getComponentType()
    {
        if (isArray() && (m_componentType == null))
        {
            ...
            {
                m_componentType = m_classInfoRepository.getClassInfo(componentType
                        .getName());
            }
            else
            {
    ...
    private static String convertArrayTypeName(final String typeName)
    {
        ...
        if (index != -1)
        {
            ...
            {
                arrayType.append(typeName.substring(index + 2,
                        typeName.length() - 1));
            }
    ...
    public boolean equals(Object o)
    {
        ...
        if ((m_attributes != null)
            ? (!m_attributes.equals(javaClassInfo.m_attributes))
            : (javaClassInfo.m_attributes != null))
        {
            return false;
        }

        if ((m_class != null) ? (!m_class.equals(javaClassInfo.m_class))
                              : (javaClassInfo.m_class != null))
        {
            return false;
        }
        ...
        if ((m_classInfoRepository != null)
            ? (!m_classInfoRepository.equals(
                javaClassInfo.m_classInfoRepository))
        ...
        if ((m_componentType != null)
            ? (!m_componentType.equals(javaClassInfo.m_componentType))
        ...
        if ((m_name != null) ? (!m_name.equals(javaClassInfo.m_name))
                             : (javaClassInfo.m_name != null))
        {
            return false;
        }

        if ((m_superClass != null)
            ? (!m_superClass.equals(javaClassInfo.m_superClass))
