...
public class JavassistClassInfoRepository {
     ...
     * @param loader
     */
    private JavassistClassInfoRepository(final ClassLoader loader) {
     ...
     * @return
     */
    public static synchronized JavassistClassInfoRepository getRepository(final ClassLoader loader) {
        int hash;
    ...
    public ClassInfo checkParentClassRepository(final String className, final ClassLoader loader) {
        ...
        if (parent == null) {
            ...
            info = JavassistClassInfoRepository.getRepository(parent).getClassInfo(className);
            if (info != null) {
                return info;
            } else {
