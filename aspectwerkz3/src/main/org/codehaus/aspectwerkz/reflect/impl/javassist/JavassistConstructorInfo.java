 ...
 */
public class JavassistConstructorInfo extends JavassistCodeInfo
    implements ConstructorInfo
{
     ...
     * @param loader
     */
    public JavassistConstructorInfo(final CtConstructor constructor,
     ...
     */
    public static JavassistConstructorInfo getConstructorInfo(
        final CtConstructor constructor, final ClassLoader loader)
    {
        JavassistConstructorInfo constructorInfo = (JavassistConstructorInfo) s_cache
            .get(constructor);
     ...
     */
    public static void addConstructorInfo(final CtConstructor constructor,
        final JavassistConstructorInfo methodInfo)
    {
    ...
    public boolean equals(Object o)
    {
        ...
        if ((m_attributes != null)
            ? (!m_attributes.equals(javassistCodeInfo.m_attributes))
            : (javassistCodeInfo.m_attributes != null))
        {
            return false;
        }

        if ((m_member != null) ? (!m_member.equals(javassistCodeInfo.m_member))
                               : (javassistCodeInfo.m_member != null))
        {
            return false;
        }
        ...
        if ((m_classInfoRepository != null)
            ? (!m_classInfoRepository.equals(
                javassistCodeInfo.m_classInfoRepository))
        ...
        if ((m_declaringType != null)
            ? (!m_declaringType.equals(javassistCodeInfo.m_declaringType))
        ...
        if ((m_loader != null) ? (!m_loader.equals(javassistCodeInfo.m_loader))
                               : (javassistCodeInfo.m_loader != null))
        {
            return false;
        }
