...
set ASPECTWERKZ_LIBS=%ASPECTWERKZ_HOME%\lib\FAKEasm-1.5.1.jar;%ASPECTWERKZ_HOME%\lib\FAKEasm-attrs-1.5.1.jar;%ASPECTWERKZ_HOME%\lib\dom4j-1.4.jar;%ASPECTWERKZ_HOME%\lib\qdox-1.4.jar;%ASPECTWERKZ_HOME%\lib\concurrent-1.3.1.jar;%ASPECTWERKZ_HOME%\lib\trove-1.0.2.jar;%ASPECTWERKZ_HOME%\lib\jrexx-1.1.1.jar
