...
/**
 * Implements the Aspect concept. Manages pointcuts A introductions for a
 * defined by this aspect.
 *
 * @author <a href="mailto:jboner@codehaus.org">Jonas Bonér</a>
 * @version $Id: Aspect.java,v 1.7 2003-07-03 13:10:49 jboner Exp $
 */
public class Aspect {
    ...
    /**
     * Creates a new throws pointcut for the method A exception specified.
     *
     * @param pattern the pattern
     * @return the pointcut
     */
