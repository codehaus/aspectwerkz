...
public class AspectWerkzC {
     ...
     *
     * The ClassLoader will be set to "null" when transform(className, byteCode, callerClassLoader)
        ...
        try {
            ...
            for (Enumeration e = zip.entries(); e.hasMoreElements(); ) {
                ...
                if (ze.getName().toLowerCase().endsWith(".class")) {
                    ...
                    transformed = preprocessor.preProcess(ze.getName().substring(0, ze.getName().length()-6), bos.toByteArray(), null);
                } else {
