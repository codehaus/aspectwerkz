 ...
 */
public class ConstructorExecutionJoinPointRedefiner extends ConstructorExecutionJoinPointCompiler {
    /**
     * The redefined model.
     */
     ...
     * @param model
     */
    ConstructorExecutionJoinPointRedefiner(final CompilationInfo model) {
