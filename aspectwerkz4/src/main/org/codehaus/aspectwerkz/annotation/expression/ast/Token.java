...
public class Token {
     ...
     * subclass of Token called IDToken that you want to create if ofKind is ID, simlpy add something like : <p/>case
     * MyParserConstants.ID : return new IDToken(); <p/>to the following switch statement. Then you can cast
