...
public class IntroductionTest extends TestCase {
    ...
    public void testMixinInterfaceIntroduction() {
        assertTrue(m_toBeIntroduced instanceof test.mixin.Introductions);
    }
...
/*
    public void testReplaceImplementation() {
        assertEquals("test.mixin.IntroductionTestAspect$MyImpl", SystemLoader.getCflowStack(this)
                .getAspectManager("tests").getMixin("test.mixin.IntroductionTestAspect$MyImpl")
        ...
        SystemLoader.getCflowStack(this).getAspectManager("tests").getMixin(
            "test.mixin.IntroductionTestAspect$MyImpl").swapImplementation(
            "test.mixin.IntroductionTestAspect$MyOtherImpl");
        assertEquals(-1, ((Introductions) m_toBeIntroduced).intArg(1));
        assertEquals("test.mixin.IntroductionTestAspect$MyOtherImpl", SystemLoader.getCflowStack(this)
                .getAspectManager("tests").getMixin("test.mixin.IntroductionTestAspect$MyImpl")
                .getImplementationClassName());
    }
    ...
    public void testReplaceImplementationToAutonomousOne() {
        ...
        assertEquals("test.mixin.IntroductionTestAspectMyImplReplacement", SystemLoader.getCflowStack(
            this).getAspectManager("tests").getMixin("test.mixin.IntroductionTestAspect$MyImpl")
                .getImplementationClassName());
    }
*/
